...
typedef PyObject *(*__Pyx_PyCFunctionFast)(PyObject *self, PyObject **args, Py_ssize_t nargs, PyObject *kwnames);
#else
...
#endif
#endif
template <typename T> void __Pyx_call_destructor(T &x)
{
    x.~T();
}
template <typename T> class __Pyx_FakeReference
{
    ...
    template <typename U> bool operator==(U other)
    {
        return *ptr == other;
    }
    template <typename U> bool operator!=(U other)
...
#define __PYX_HAVE__t
#define __PYX_HAVE_API__t
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static int __Pyx_init_sys_getdefaultencoding_params(void)
{
    ...
    else
    {
        ...
        {
            PyErr_Format(PyExc_ValueError, "This module compiled with c_string_encoding=ascii, but default encoding '%.200s' is not a superset of ascii.",
                         default_encoding_c);
            goto bad;
        }
...
/* Module declarations from 't' */
#define __Pyx_MODULE_NAME "t"
int __pyx_module_is_main_t = 0;
 ...
 * print(s[0 : 3])             # <<<<<<<<<<<<<<
 */
    __pyx_slice_ = PySlice_New(__pyx_int_0, __pyx_int_3, Py_None);
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initt(void); /*proto*/
PyMODINIT_FUNC initt(void)
#else
PyMODINIT_FUNC PyInit_t(void); /*proto*/
...
#endif
    __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_t(void)", 0);
...
/*--- Module creation code ---*/
#if PY_MAJOR_VERSION < 3
    __pyx_m = Py_InitModule4("t", __pyx_methods, 0, 0, PYTHON_API_VERSION);
    Py_XINCREF(__pyx_m);
#else
...
#if PY_MAJOR_VERSION >= 3
    {
        ...
        if(unlikely(!modules))
            __PYX_ERR(0, 2, __pyx_L1_error)
        if(!PyDict_GetItemString(modules, "t"))
        {
            if(unlikely(PyDict_SetItemString(modules, "t", __pyx_m) < 0))
                __PYX_ERR(0, 2, __pyx_L1_error)
        }
    }
#endif
 ...
 * print(s[0 : 3])
 */
    if(PyDict_SetItem(__pyx_d, __pyx_n_s_s, __pyx_n_s_hello) < 0)
        __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 * print(s[0 : 3])             # <<<<<<<<<<<<<<
 */
    __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_s);
    if(unlikely(!__pyx_t_1))
        __PYX_ERR(0, 3, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyObject_GetSlice(__pyx_t_1, 0, 3, NULL, NULL, &__pyx_slice_, 1, 1, 1);
    if(unlikely(!__pyx_t_2))
        __PYX_ERR(0, 3, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1);
    __pyx_t_1 = 0;
    if(__Pyx_PrintOne(0, __pyx_t_2) < 0)
        __PYX_ERR(0, 3, __pyx_L1_error)
...
__pyx_L1_error:;
    ...
    if(__pyx_m)
    {
        if(__pyx_d)
        {
            __Pyx_AddTraceback("init t", __pyx_clineno, __pyx_lineno, __pyx_filename);
        }
        Py_DECREF(__pyx_m);
        __pyx_m = 0;
    }
    ...
    {
        PyErr_SetString(PyExc_ImportError, "init t");
    }
__pyx_L0:;
    __Pyx_RefNannyFinishContext();
#if PY_MAJOR_VERSION < 3
...
__Pyx_CreateCodeObjectForTraceback(const char *funcname, int c_line, int py_line, const char *filename)
{
    ...
    if(!py_funcname)
        goto bad;
    py_code = __Pyx_PyCode_New(0, 0, 0, 0, 0, __pyx_empty_bytes, /*PyObject *code,*/
...
static CYTHON_INLINE long __Pyx_PyInt_As_long(PyObject *x)
{
    ...
    if(likely(PyLong_Check(x)))
    {
        if(is_unsigned)
        {
            ...
            case 2:
                if(8 * sizeof(long) > 1 * PyLong_SHIFT)
                {
                    ...
                    {
                        __PYX_VERIFY_RETURN_INT(long, unsigned long,
            ...
            case 3:
                if(8 * sizeof(long) > 2 * PyLong_SHIFT)
                {
                    if(8 * sizeof(unsigned long) > 3 * PyLong_SHIFT)
                    {
                        ...
                        long, unsigned long,
                        (((((((unsigned long)digits[2]) << PyLong_SHIFT) | (unsigned long)digits[1]) << PyLong_SHIFT)
                          | (unsigned long)digits[0])))
                    }
            ...
            case 4:
                if(8 * sizeof(long) > 3 * PyLong_SHIFT)
                {
                    if(8 * sizeof(unsigned long) > 4 * PyLong_SHIFT)
                    {
                        __PYX_VERIFY_RETURN_INT(
                        long, unsigned long,
                        (((((((((unsigned long)digits[3]) << PyLong_SHIFT) | (unsigned long)digits[2]) << PyLong_SHIFT)
                    ...
                    {
                        return (long)(((((((((long)digits[3]) << PyLong_SHIFT) | (long)digits[2]) << PyLong_SHIFT)
                                         | (long)digits[1])
                                        << PyLong_SHIFT)
                                       | (long)digits[0]));
                    }
            ...
            case -3:
                if(8 * sizeof(long) - 1 > 2 * PyLong_SHIFT)
                {
                    if(8 * sizeof(unsigned long) > 3 * PyLong_SHIFT)
                    {
                        __PYX_VERIFY_RETURN_INT(
                        long, long,
                        -(long)(((((((unsigned long)digits[2]) << PyLong_SHIFT) | (unsigned long)digits[1]) << PyLong_SHIFT)
                                 | (unsigned long)digits[0])))
                    }
            ...
            case -4:
                if(8 * sizeof(long) - 1 > 3 * PyLong_SHIFT)
                {
                    if(8 * sizeof(unsigned long) > 4 * PyLong_SHIFT)
                    {
                        __PYX_VERIFY_RETURN_INT(
                        long, long,
                        -(long)(((((((((unsigned long)digits[3]) << PyLong_SHIFT) | (unsigned long)digits[2]) << PyLong_SHIFT)
                                   | (unsigned long)digits[1])
                                  << PyLong_SHIFT)
                                 | (unsigned long)digits[0])))
                    }
        ...
        }
        {
            ...
            PyErr_SetString(PyExc_RuntimeError, "_PyLong_AsByteArray() not available in PyPy, "
        ...
        if(is_unsigned)
        {
            ...
            case 4:
                if(8 * sizeof(int) > 3 * PyLong_SHIFT)
                {
                    ...
                    {
                        return (int)(((((((((int)digits[3]) << PyLong_SHIFT) | (int)digits[2]) << PyLong_SHIFT)
                                        | (int)digits[1])
                                       << PyLong_SHIFT)
                                      | (int)digits[0]));
                    }
        ...
        else
        {
            ...
            case 4:
                if(8 * sizeof(int) > 3 * PyLong_SHIFT)
                {
                    ...
                    {
                        return (int)((
                        ((((((((int)digits[3]) << PyLong_SHIFT) | (int)digits[2]) << PyLong_SHIFT) | (int)digits[1]) << PyLong_SHIFT)
                         | (int)digits[0])));
                    }
                }
                break;
...
static CYTHON_INLINE PyObject *__Pyx_PyNumber_IntOrLong(PyObject *x)
{
    ...
    if(res)
    {
        ...
        {
#endif
            PyErr_Format(PyExc_TypeError, "__%.4s__ returned non-%.4s (type %.200s)", name, name,
                         Py_TYPE(res)->tp_name);
            Py_DECREF(res);
            return NULL;
        }
    ...
    if(likely(PyLong_CheckExact(b)))
    {
        ...
        else
        {
            ...
            case 4:
                ...
                {
                    return (Py_ssize_t)(((((((((size_t)digits[3]) << PyLong_SHIFT) | (size_t)digits[2]) << PyLong_SHIFT)
                                           | (size_t)digits[1])
                                          << PyLong_SHIFT)
                                         | (size_t)digits[0]));
                }
